...
public class Anbiru extends Block {
    ...
    public boolean onBlockActivated(World parWorld, BlockPos parBlockPos, IBlockState parIBlockState, EntityPlayer parPlayer,
        ...
        if(!parWorld.isRemote){
            // DEBUG
            System.out.println("Anbiru onBlockActivated");
             parPlayer.openGui(Main.instance, GuiID.ANBIRU.ordinal(), parWorld, parBlockPos.getX(), parBlockPos.getY(), parBlockPos.getZ());
        }
        return true;
    }
