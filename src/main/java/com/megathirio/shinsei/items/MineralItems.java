...
import com.megathirio.shinsei.blocks.MineralMap;
...
public class MineralItems {
    ...
    public static HashMap<String, Item> mineralItemMap = new MineralMap().getMineralItemMap();

    public static void createMineralItems(){
        MineralMap.addMineralItems();
        for(Map.Entry<String, Item> mapEntry : mineralItemMap.entrySet()) {
    ...
    public static Item getItem(String itemName){
        return mineralItemMap.get(itemName);
    }
}
