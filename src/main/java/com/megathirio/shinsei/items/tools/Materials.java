...
public class Materials {
    ...
    public static Item.ToolMaterial materialBone = EnumHelper.addToolMaterial("BONE", 1, 12, 1.5F, 0.5F, 0);
    ...
    public static Item.ToolMaterial materialFlint = EnumHelper.addToolMaterial("FLINT", 1, 12, 2.0F, 1.0F, 0);
